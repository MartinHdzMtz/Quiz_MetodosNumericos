 ...
 * @author asus-01
 */
public class soluciondeecuacioneslineales extends javax.swing.JFrame {

    /**
     * Creates new form inicio
     */
    public soluciondeecuacioneslineales() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("Una ecuación de primer grado o ecuación lineal es una igualdad \nque involucra una o más variables a la primera potencia y no \ncontiene productos entre las variables, es decir, una ecuación \nque involucra solamente sumas y restas de una variable a la \nprimera potencia. En todo anillo conmutativo pueden definirse \necuaciones de primer grado.");
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(soluciondeecuacioneslineales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new soluciondeecuacioneslineales().setVisible(true);
            }
        });
    }
