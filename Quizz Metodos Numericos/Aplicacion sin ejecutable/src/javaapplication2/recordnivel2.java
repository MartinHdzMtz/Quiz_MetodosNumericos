 ...
 * @author asus-01
 */
public class recordnivel2 extends javax.swing.JFrame {
 ...
 TInicio = System.currentTimeMillis();
  ...
  tiempousuario=(tiempo/1000)/60;}
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Record Nivel 2");
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(recordnivel2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new recordnivel2().setVisible(true);
            }
        });
    }
